...
const Component = (props) => {
    ...
    const OnSubmit = async () => {
        let rslt, data, prodImages, petCareCenterId, numfields;
        ...
        inlineObjs.forEach(x => {
            ...
            let valueList = [];
            _values.forEach(m => {
                ['action', 'ServiceId', 'id'].forEach(z => delete m[z]);
            ...
            petcarecenter.push({ key: x.property, value: valueList, type: "collections" });
        });
